...
APP_MAP = {
    ...
    "//apps/link-measurement:onos-apps-link-measurement-oar": [],
    
    "//apps/foo-app:onos-apps-foo-app-oar": [],
    # "//apps/link-quality-measurement:onos-apps-link-quality-measurement-oar": [],
    # "//apps/lqm:link-quality-measurement-oar": [],
}
